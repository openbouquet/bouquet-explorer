...
(function (root, factory) {
    ...
    var View = Backbone.View.extend({
        ...
        projectGuide: function() {
            // Instance the tour
            if (! this.projectTour && ! this.config.get("project")) {
        ...
        domainGuide: function() {
            // Instance the tour
            if (! this.domainTour && ! this.config.get("domain")) {
        ...
        mainGuide: function(forceStart) {
            ...
            if (! this.mainTour && this.config.get("domain")) {
                // Instance the tour
            ...
            // Start the tour
            if (this.mainTour && ! this.config.get("tourSeen")) {
                this.mainTour.start();
            }
            if (this.mainTour && forceStart === true) {
